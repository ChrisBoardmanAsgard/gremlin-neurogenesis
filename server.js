...
function serverSnapshot() {
  ...
  return {
    ...
    speechCoherenceScore: best.speechCoherenceScore || best.metadata?.speechCoherenceScore || 0,
    passiveLearningScore: best.passiveLearningScore || best.metadata?.passiveLearningScore || 0,
...
async function serverEvolutionTick() {
  ...
  try {
    ...
    broadcastEvent("evolution", {
      ...
      speechCoherenceScore: serverLab.best().speechCoherenceScore || 0,
      passiveLearningScore: serverLab.best().passiveLearningScore || 0,
